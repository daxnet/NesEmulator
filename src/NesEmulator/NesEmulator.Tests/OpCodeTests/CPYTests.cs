...
namespace NesEmulator.Tests.OpCodeTests
{
    public class CPYTests
    {
        ...
        {
            var program = new byte[] { 0xc0, 0x50 };
            emulator.Cpu.LoadAndRun(program, e => e.Cpu.Y = 0x50);
        ...
        {
            var program = new byte[] { 0xc0, 0x50 };
            emulator.Cpu.LoadAndRun(program, e => e.Cpu.Y = 0x51);
        ...
        {
            var program = new byte[] { 0xc0, 0x50 };
            emulator.Cpu.LoadAndRun(program, e => e.Cpu.Y = 0x49);
        ...
        public void ZeroPageAddressingTest()
        {
            ...
            var program = new byte[] { 0xc4, 0x10 };
